const counties = [
    ...
    "Wilcox, Alabama",
    "Winston, Alabama",
    "Aleutians East Borough[d], Alaska",
    "Aleutians West Census Area[e], Alaska",
    "Anchorage, Municipality of[d][f], Alaska",
    "Bethel Census Area[e], Alaska",
    "Bristol Bay Borough[d], Alaska",
    "Chugach Census Area[e], Alaska",
    "Copper River Census Area[e], Alaska",
    "Denali Borough[d], Alaska",
    "Dillingham Census Area[e], Alaska",
    "Fairbanks North Star Borough[d], Alaska",
    "Haines Borough[d], Alaska",
    "Hoonah–Angoon Census Area[e], Alaska",
    "Juneau, City and Borough of[d][g], Alaska",
    "Kenai Peninsula Borough[d], Alaska",
    "Ketchikan Gateway Borough[d], Alaska",
    "Kodiak Island Borough[d], Alaska",
    "Kusilvak Census Area[e], Alaska",
    "Lake and Peninsula Borough[d], Alaska",
    "Matanuska-Susitna Borough[d], Alaska",
    "Nome Census Area[e], Alaska",
    "North Slope Borough[d], Alaska",
    "Northwest Arctic Borough[d], Alaska",
    "Petersburg Borough[d][h], Alaska",
    "Prince of Wales – Hyder Census Area[e], Alaska",
    "Sitka, City and Borough of[d][i], Alaska",
    "Skagway, Municipality of[d], Alaska",
    "Southeast Fairbanks Census Area[e], Alaska",
    "Wrangell, City and Borough of[d], Alaska",
    "Yakutat, City and Borough of[d][j], Alaska",
    "Yukon–Koyukuk Census Area[e], Alaska",
    "Eastern District[12], American Samoa",
    "Manu'a District[12], American Samoa",
    "Rose Atoll (Rose Island)[12], American Samoa",
    "Swains Island[12], American Samoa",
    "Western District[12], American Samoa",
    "Apache, Arizona",
    "Cochise, Arizona",
    "Coconino, Arizona",
    "Gila, Arizona",
    ...
    "San Francisco, City and County of[k], California",
    ...
    "Bent, Colorado",
    "Boulder, Colorado",
    "Broomfield, City and County of[l], Colorado",
    "Chaffee, Colorado",
    "Cheyenne, Colorado",
    ...
    "Custer, Colorado",
    "Delta, Colorado",
    "Denver, City and County of[m], Colorado",
    "Dolores, Colorado",
    "Douglas, Colorado",
    "Eagle, Colorado",
    "Elbert, Colorado",
    ...
    "Weld, Colorado",
    "Yuma, Colorado",
    "Fairfield[n], Connecticut",
    "Hartford[n], Connecticut",
    "Litchfield[n], Connecticut",
    "Middlesex[n], Connecticut",
    "New Haven[n], Connecticut",
    "New London[n], Connecticut",
    "Tolland[n], Connecticut",
    "Windham[n], Connecticut",
    "Kent, Delaware",
    "New Castle, Delaware",
    "Sussex, Delaware",
    "District of Columbia[o], District of Columbia",
    "Alachua, Florida",
    "Baker, Florida",
    "Bay, Florida",
    "Bradford, Florida",
    ...
    "Guam[9], Guam",
    "Hawaii, Hawaiʻi",
    "Honolulu, City and County of[p], Hawaiʻi",
    "Kalawao, Hawaiʻi",
    "Kauai, Hawaiʻi",
    "Maui, Hawaiʻi",
    "Ada, Idaho",
    ...
    "Wicomico, Maryland",
    "Worcester, Maryland",
    "Baltimore City[r], Maryland",
    "Barnstable, Massachusetts",
    "Berkshire[n], Massachusetts",
    "Bristol, Massachusetts",
    "Dukes, Massachusetts",
    "Essex[n], Massachusetts",
    "Franklin[n], Massachusetts",
    "Hampden[n], Massachusetts",
    "Hampshire[n], Massachusetts",
    "Middlesex[n], Massachusetts",
    "Nantucket, Town and County of[s], Massachusetts",
    "Norfolk, Massachusetts",
    "Plymouth, Massachusetts",
    "Suffolk[n], Massachusetts",
    "Worcester[n], Massachusetts",
    "Alcona, Michigan",
    "Alger, Michigan",
    "Allegan, Michigan",
    "Alpena, Michigan",
    ...
    "Washoe, Nevada",
    "White Pine, Nevada",
    "Carson City, Consolidated Municipality of[u], Nevada",
    ...
    "Northern Islands Municipality[9], Northern Mariana Islands",
    ...
    "Bristol[n], Rhode Island",
    "Kent[n], Rhode Island",
    "Newport[n], Rhode Island",
    "Providence[n], Rhode Island",
    "Washington[n], Rhode Island",
    ...
    "Zapata, Texas",
    "Zavala, Texas",
    "Bajo Nuevo Bank[x][y], U.S. Minor Outlying Islands",
    "Baker Island[8][x], U.S. Minor Outlying Islands",
    "Howland Island[x], U.S. Minor Outlying Islands",
    "Jarvis Island[x], U.S. Minor Outlying Islands",
    "Johnston Atoll[x], U.S. Minor Outlying Islands",
    "Kingman Reef[x], U.S. Minor Outlying Islands",
    "Midway Islands[x], U.S. Minor Outlying Islands",
    "Navassa Island[x], U.S. Minor Outlying Islands",
    "Palmyra Atoll[x], U.S. Minor Outlying Islands",
    "Serranilla Bank[x][y], U.S. Minor Outlying Islands",
    "Wake Island[x], U.S. Minor Outlying Islands",
    "Beaver, Utah",
    "Box Elder, Utah",
    "Cache, Utah",
    "Carbon, Utah",
    ...
    "Windham, Vermont",
    "Windsor, Vermont",
    "Saint Croix Island[9], Virgin Islands (U.S.)",
    "Saint John Island, Virgin Islands (U.S.)",
    ...
    "Wythe, Virginia",
    "York, Virginia",
    "Alexandria, City of[aa], Virginia",
    "Bristol, City of[aa], Virginia",
    "Buena Vista, City of[aa], Virginia",
    "Charlottesville, City of[aa], Virginia",
    "Chesapeake, City of[aa], Virginia",
    "Colonial Heights, City of[aa], Virginia",
    "Covington, City of[aa], Virginia",
    "Danville, City of[aa], Virginia",
    "Emporia, City of[aa], Virginia",
    "Fairfax, City of[aa], Virginia",
    "Falls Church, City of[aa], Virginia",
    "Franklin, City of[aa], Virginia",
    "Fredericksburg, City of[aa], Virginia",
    "Galax, City of[aa], Virginia",
    "Hampton, City of[aa], Virginia",
    "Harrisonburg, City of[aa], Virginia",
    "Hopewell, City of[aa], Virginia",
    "Lexington, City of[aa], Virginia",
    "Lynchburg, City of[aa], Virginia",
    "Manassas, City of[aa], Virginia",
    "Manassas Park, City of[aa], Virginia",
    "Martinsville, City of[aa], Virginia",
    "Newport News, City of[aa], Virginia",
    "Norfolk, City of[aa], Virginia",
    "Norton, City of[aa], Virginia",
    "Petersburg, City of[aa], Virginia",
    "Poquoson, City of[aa], Virginia",
    "Portsmouth, City of[aa], Virginia",
    "Radford, City of[aa], Virginia",
    "Richmond, City of[aa], Virginia",
    "Roanoke, City of[aa], Virginia",
    "Salem, City of[aa], Virginia",
    "Staunton, City of[aa], Virginia",
    "Suffolk, City of[aa], Virginia",
    "Virginia Beach, City of[aa], Virginia",
    "Waynesboro, City of[aa], Virginia",
    "Williamsburg, City of[aa], Virginia",
    "Winchester, City of[aa], Virginia",
    "Adams, Washington",
    "Asotin, Washington",
    "Benton, Washington",
    "Chelan, Washington",
